...
<div class="c-layout-page" style="display:none">
	<div class="c-content-box qp-top-nobottom c-bg-white">
		<div class="container">
					...
					<form id="qpay_form" name="qpay_form" action="https://pg.qpayindia.com/wwws/Payment/PaymentDetails.aspx" method="POST" enctype="multipart/form-data">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="hidden" class="validation form-control" name="ResponseURL" id="ResponseURL" value="http://localhost/E-Learning/devresponse.php" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="hidden" class="validation form-control" name="OrderID" id="OrderID" value="12345" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="hidden" class="validation form-control" name="Mode" id="Mode" value="TEST" />
							</div>
							<div class="form-group">
		  ...
		  $inputValues=
                $secretKey
                ."|http://localhost/E-Learning/devresponse.php"
                ."|".$merchant_id
                ."|".$password
                ."|PURCHASE"
                ."|".$order_id
        ...
        $secure_hash = strtoupper(hash('sha512', $inputValues));
							...
							<div class="form-group">
								...
								<input type="hidden" class="validation form-control" name="name" id="name" value="test" />
							</div>
							<div class="form-group">
								<label class="text-label" for="firstname">Address <span class="mandatory">*</span> </label>
								<input type="hidden" class="validation form-control" name="address" id="address" value="test" />
							</div>
							<div class="form-group">
								<label class="text-label" for="firstname">City <span class="mandatory">*</span> </label>
								<input type="hidden" class="validation form-control" name="city" id="city" value="test" />
							</div>
							<div class="form-group">
								<label class="text-label" for="firstname">State <span class="mandatory">*</span> </label>
								<input type="hidden" class="validation form-control" name="state" id="state" value="test" />
							</div>
							<div class="form-group">
								<label class="text-label" for="firstname">Country <span class="mandatory">*</span> </label>
								<input type="hidden" class="validation form-control" name="country" id="country" value="test" />
							</div>
							<div class="form-group">
								<label class="text-label" for="firstname">Postal Code <span class="mandatory">*</span> </label>
								<input type="hidden" class="validation form-control" name="postal_code" id="postal_code" value="12345" />
							</div>
							<div class="form-group">
								<label class="text-label" for="firstname">Phone <span class="mandatory">*</span> </label>
								<input type="hidden" class="validation form-control" name="phone" id="phone" value="9962449901" />
							</div>
							<div class="form-group">
								<label class="text-label" for="firstname">Email <span class="mandatory">*</span> </label>
								<input type="hidden" class="validation form-control" name="email" id="email" value="test@test.com" />
							</div>
