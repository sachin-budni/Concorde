...
?>
<div class="alert alert-success" role="alert">
	Video link edited <strong>Successfully.</strong>
</div>
<?php
}
?>
...
?>	
				...
				<div class="panel-body">
					<form role="form" class="form-horizontal" method="post" action="admin_add_link_db.php"  >
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">							
									...
									<input type="text" class="form-control1" name="videolink" id="videolink">
								</div>
							</div>
						</div>
