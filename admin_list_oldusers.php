...
?>
<ol class="breadcrumb">
   <li class="breadcrumb-item"><a href="admindashboard.php">Home</a><i class="fa fa-angle-right"></i>Listing Existing Users</li>
</ol>
<?php
...
?>
		...
		<?php		
		$totalquery = "SELECT COUNT(1) cnt FROM `users` WHERE new_user = 'N' ";
		...
		$newusersql = "SELECT u.* FROM users u WHERE u.new_user = 'N' ";
					...
					<div class="w3l-table-info">
					  ...
					  <nav aria-label="...">
							...
							<?php
								...
								{
							?>
								<li class="page-item <?php if($pageno==$i){ echo"active"; }?>"><a class="page-link" href="admin_list_oldusers.php?pageno=<?php echo $i;?>"><?php echo $i;?></a></li>
							<?php
								}
							?>
							  </ul>
						...
						<tbody>
						<?php
						$query = "SELECT u.* FROM users u WHERE u.new_user = 'N' ORDER BY u.name LIMIT $per_page OFFSET $offset";
