...
<ol class="breadcrumb">
   <li class="breadcrumb-item"><a href="userdashboard.php">Home</a><i class="fa fa-angle-right"></i>Online Test</li>
		...
		$totalquery = "SELECT COUNT(1) cnt FROM `test_file` t WHERE t.chapter_id = '$chapter_id' AND t.sub_chapter_id = '0' ";
		...
		//$question_number = 1;
		?>
		<form method="get" action="processquestion_chapter.php" enctype="multipart/form-data" onsubmit="check_choices_selected();">
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <?php echo "<h2> Question ".$pageno." of ".$tot_cnt['cnt']."</h2>"; ?>
					    <?php
						$query = "SELECT tf.* FROM test_file tf  WHERE tf.chapter_id = '$chapter_id' AND tf.sub_chapter_id = '0' ORDER BY tf.test_id LIMIT $per_page OFFSET $offset";
