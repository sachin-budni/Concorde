...
?>
<ol class="breadcrumb">
   <li class="breadcrumb-item"><a href="admindashboard.php">Home</a><i class="fa fa-angle-right"></i>View Test Questions</li>
</ol>
		
				<div class="agile-grids">
				<!-- tables -->	
				<div class="panel-body">
					<form role="form" class="form-horizontal" method="post" action="admin_test_listing_db.php"  >
						...
						<input class="btn btn-primary" type="submit" name="viewtest" value="View Test Question">
