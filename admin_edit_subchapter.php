...
$subchapterquery="SELECT * FROM `sub_chapters` WHERE `sub_chapter_id`='$sub_chapter_id'";
$subchapterresult = mysqli_query($con,$subchapterquery);
while($subchapterrow=mysqli_fetch_array($subchapterresult))
{
?>					
				<div class="agile-grids">
				<!-- tables -->	
				<div class="panel-body">
					<form role="form" class="form-horizontal" method="post" action="admin_edit_subchapter_db.php" enctype="multipart/form-data" >
					<input type="hidden" name="sub_chapter_id" id="sub_chapter_id" value="<?php echo $sub_chapter_id; ?>">
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">							
									...
									{
									?>
									<option value="<?php echo $row['category_id']; ?>" <?php if ($subchapterrow['category_id']==$row['category_id']) { echo "selected=select"; }?>><?php echo $row['category_name']; ?></option>
									<?php
									}
									?>									
									</select>
						...
						<input class="btn btn-primary" type="submit" name="editsubchapter" value="Edit Sub Chapter">
